...
- Repo fuente macOS: `~/.nuke/LGA_ToolPack-B/`.
- Repo fuente Windows: `%USERPROFILE%\\.nuke\\LGA_ToolPack-B\\`.
- `menu.py` es un wrapper mínimo de compatibilidad de host.
- `LGA_ToolPackB_menu.py` contiene la implementación completa del menú.
...
- El bump real se hace únicamente mediante
  `LGA_Release/_LGA_ReleaseGen-ToolPack-B.bat`, cuando el usuario lo pide.
