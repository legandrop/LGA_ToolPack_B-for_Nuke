...
____________________________________________________________________
  ...
  LGA_ToolPackB_EnabledPanel v1.05 | Lega
  ...
  Modulos de esta tool (todos van con la misma version):
    LGA_ToolPackB_EnabledPanel.py   <- este, el principal (la ventana)
    LGA_ToolPackB_Enabled.py        <- el core que lee y guarda los flags
...
from LGA_QtAdapter_ToolPackB import QtWidgets, QtCore
from LGA_UI_Style_ToolPackB import Color, Metric, Style, apply_ui_font

import LGA_ToolPackB_Enabled as enabled_config
...
class EnabledPanel(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("LGA ToolPack-B - Enable Tools")
