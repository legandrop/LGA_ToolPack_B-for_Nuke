...
____________________________________________________________________
  ...
  LGA_UI_Style_ToolPackB v1.23 | Lega

  Punto UNICO de ajuste del look de las ventanas del ToolPack B. Todo lo
  ...
  Uso:
      ...
      from LGA_UI_Style_ToolPackB import Style, colorize_path, emphasis
  ...
  v1.04: Style.TOOLTIP, para que un pack sin el helper de tooltips
         del ToolPack B igual los pinte como los demas.
...
THEMES = (
    {
        ...
        "label": "Pack",
        "desc": (
            "Lo que hay hoy en LGA_UI_Style_ToolPackB: gris 212121 y el violeta de la marca."
        ),
        "colors": {
            "WINDOW": "#212121",
            "SURFACE": "#272727",
...
def _register(archivo):
    ...
    """
    try:
        from LGA_QtAdapter_ToolPackB import QtGui
    except Exception:
        return ""
