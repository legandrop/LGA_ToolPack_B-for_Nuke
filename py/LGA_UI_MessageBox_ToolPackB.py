...
____________________________________________________________________
  ...
  LGA_UI_MessageBox_ToolPackB v1.00 | Lega

  Carteles estandar del pack: info, warning, error y pregunta,
  estilados con LGA_UI_Style_ToolPackB. Reemplazan a los QMessageBox
...
from LGA_UI_Style_ToolPackB import Style, apply_ui_font
